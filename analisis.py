...
links = [
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Aotizhongxin_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Changping_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Dingling_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Dongsi_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Guanyuan_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Gucheng_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Huairou_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Nongzhanguan_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Shunyi_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Tiantan_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Wanliu_20130301-20170228.csv',
    'https://raw.githubusercontent.com/RazzaTitian/proyek-bangkit/main/csv/PRSA_Data_Wanshouxigong_20130301-20170228.csv'
]

data_frames = {}

for url in links:
    city_name = url.split('_')[2]
    city_name = city_name.split('/')[-1]

    data_frames[city_name] = pd.read_csv(url)
...
first_station = list(data_frames.keys())[0]

period_df = data_frames[first_station][(data_frames[first_station]['date_time'] >= '2015-01') & (data_frames[first_station]['date_time'] < '2015-12')]
fig, ax = plt.subplots()

sns.scatterplot(data=specific_period_df, x='TEMP', y='PM2.5', ax=ax)
ax.set_title('Correlation between Temperature and PM2.5 for the period')
...
st.write(f"The correlation coefficient between temperature and PM2.5 for that period is: {correlation}")
